        ...
        <div className="relative w-full py-20 md:py-32 overflow-hidden">
            ...
            <div className="relative z-10 max-w-7xl mx-auto px-4 md:px-6 text-center text-white">
                ...
                <div className="flex flex-col sm:flex-row gap-8 justify-center items-center mb-16">
                    <button className="group hidden relative overflow-hidden px-16 py-6 bg-[#C2D92C] text-[#113F64] font-bold text-2xl rounded-2xl hover:scale-105 transform transition-all shadow-2xl">
