                    ...
                    {cardData.map((industry, index) => {
                        ...
                        return (
                            <div
                                key={index}
                                data-index={index}
                                className={`industry-card group relative overflow-hidden rounded-2xl transition-all duration-500 cursor-pointer bg-white shadow-lg hover:shadow-2xl hover:-translate-y-3 hover:scale-105 border-2 border-transparent hover:border-white ${visibleCards[index] ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
                                    }`}
                                style={{
                            ...
                            >
                                ...
                                {/* Content */}
                                <div className="relative z-10 p-6 md:h-[220px] md:w-[220px] flex flex-col items-center justify-center text-center">
                                    {/* Icon Container */}
                                    <div className="mb-6">
                                        <div
                                            className={`w-16 h-16 md:w-20 md:h-20 mx-auto rounded-2xl flex items-center justify-center text-3xl md:text-4xl transition-all duration-300 group-hover:scale-110 group-hover:rotate-6 ${hoveredCard === index ? 'shadow-2xl' : 'shadow-lg'
                                                }`}
                                            style={{
