...
const ProductivityCard = ({
    ...
    return (
        <div className='w-full min-h-[300px] max-w-[948px] flex flex-col sm:flex-row' >
            ...
            <div className='w-full xl:w-3/5 flex justify-center items-center p-4 bg-bg-powder-blue' >
